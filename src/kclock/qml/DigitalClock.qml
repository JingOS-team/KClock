...
Item {
    ...
    // 12 / 24
    property bool is12HoursType: true
    ...
    Rectangle {
        ...
        RowLayout {
            ...
            Text {
                font.pointSize: digitalFontSize
            ...
            Text {
                font.pointSize: amFontSize
                text: kclockFormat.hours > 12 ? "PM" : "AM"
                color: "white"
                anchors.top: txt_minutes.top
                anchors.topMargin: 34 * appwindow.officalScale

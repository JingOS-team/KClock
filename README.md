...
Jing-KClock is based on KClock [gitlab](https://invent.kde.org/plasma-mobile/kclock/) , a beautifully designed clock that conforms to the JingOS style and has a compatible `pad / desktop`  experience.
